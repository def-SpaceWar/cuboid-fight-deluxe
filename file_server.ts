...
import { join as posixJoin } from "https://deno.land/std@0.217.0/path/posix/join.ts";
import { normalize as posixNormalize } from "https://deno.land/std@0.217.0/path/posix/normalize.ts";
...
import { SEPARATOR_PATTERN } from "https://deno.land/std@0.217.0/path/constants.ts";
import { contentType } from "https://deno.land/std@0.217.0/media_types/content_type.ts";
import { calculate, ifNoneMatch } from "https://deno.land/std@0.217.0/http/etag.ts";
import {
  isRedirectStatus,
  STATUS_CODE,
  STATUS_TEXT,
...
import { ByteSliceStream } from "https://deno.land/std@0.217.0/streams/byte_slice_stream.ts";
import { parseArgs } from "https://deno.land/std@0.217.0/cli/parse_args.ts";
import { red } from "https://deno.land/std@0.217.0/fmt/colors.ts";
import { VERSION } from "https://deno.land/std@0.217.0/version.ts";
import { format as formatBytes } from "https://deno.land/std@0.217.0/fmt/bytes.ts";
...
console.log(Deno.env.get("VITE_TURN_USERNAME"));
